...
These frozen dataclasses define the immutable grain-aware catalog model used
by the public ``selayer`` package.
...
class SemanticLayer:
    ...
    def load(cls, path: str | Path) -> SemanticLayer:
        ...
        :mod:`selayer.catalog`. The import is local to avoid a module-load cycle
        (``catalog`` imports this model module).
        """
